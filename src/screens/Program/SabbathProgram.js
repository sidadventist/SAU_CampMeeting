...
export default function SabbathProgram() {
    const data = [
        ...
        { id: 4, presenter: '', description: 'Sabbath School Lesson', time: '0830 - 1030' },
        { id: 5, presenter: '', description: 'Theme Song - Hymn 148', time: '1030 - 1040' },
        { id: 6, presenter: '', description: 'Opening Prayer', time: '1040 - 1045' },
        { id: 7, presenter: '', description: 'Divine Service', time: '1100 - 1200' },
        ...
        { id: 11, presenter: '', description: 'Lesson', time: '1515 - 1630' },
        { id: 12, presenter: '', description: 'Vespers', time: '1700 - 1800' },
